...
INDEX_TRADINGSYMBOL = "NIFTY BANK"
...
EXPIRY_DATE_STR = "25-11-2025"          # DD-MM-YYYY  (set this to actual monthly expiry)

# Start date: day after previous monthly expiry
START_DATE_STR = "19-11-2025"
...
OUTPUT_BASENAME = "NIFTY_20251125_minute"   # used as pickle filename
