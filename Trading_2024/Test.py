...
def main():
    ...
    ap.add_argument("--input", default=r"C:\Users\himan\OneDrive\Documents\pdf_images_removal", help="Input file or folder path")
    ap.add_argument("--recursive", action="store_true", help="Recurse into subfolders")
    ap.add_argument("--outdir", default=r"C:\Users\himan\OneDrive\Documents\pdf_images_removal_no", help="Output directory (optional)")
    args = ap.parse_args()
