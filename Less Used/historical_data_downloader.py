...
INDEX_EXCHANGE = "BSE"              # e.g. "NSE" for NIFTY/BANKNIFTY indices
...
OPTION_EXCHANGE = "BFO"                 # "NFO" for index options
...
EXPIRY_DATE_STR = "04-12-2025"          # DD-MM-YYYY  (set this to actual monthly expiry)

# Start date: day after previous monthly expiry
START_DATE_STR = "26-11-2025"

# Output folder and filename
# OUTPUT_DIR = "./BANKNIFTY_20251125_expiry_history"
# OUTPUT_BASENAME = "BANKNIFTY_20251125_minute"   # used as pickle filename
OUTPUT_DIR = "../Trading_2024/NIFTY_20251127_expiry_history"
OUTPUT_BASENAME = "SENSEX_20251204_minute"   # used as pickle filename
